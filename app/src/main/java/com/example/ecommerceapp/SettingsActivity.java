...
public class SettingsActivity extends AppCompatActivity {
    ...
    private StorageReference storageProfilePritureRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageProfilePritureRef = FirebaseStorage.getInstance().getReference().child("Profile pictures");
    ...
    private void uploadImage() {
        ...
        if(imageUri != null){
            final StorageReference fileRef = storageProfilePritureRef
